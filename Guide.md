...
### Available Versions<a name="available-versions"/>
...
### Boilerplates<a name="boilerplates"/>
...
## Basic Customization<a name="basic-customization"/>


### I18n Support<a name="i18n"/>
...
### Configuration API<a name="configuration-api"/>
...
##### AccountsTemplates.logout()<a name="logout"/>
...
### Internal States<a name="internal-states"/>
...
### Content Protection<a name="content-protection"/>
...
### reCaptcha Setup<a name="reCaptcha-setup"/>
...
### Detect reactively when a form is being processed<a name="detect-reactively-when-a-form-is-being-processed"/>
...
## Advanced Customization<a name="advanced-customization"/>



### Configuring Texts<a name="configuring-texts"/>
...
#### Button Text<a name="button-text"/>
...
#### Social Button Icons<a name="social-button-icons"/>
...
#### Input Field Icons<a name="input-icons"/>
...
#### Errors Text<a name="errors-text"/>
...
### Disabling Client-side Accounts Creation<a name="disabling-client-side-accounts-creation"/>
...
### Form Fields Configuration<a name="form-fields-configuration"/>
...
### Extending Templates<a name="extending-templates"/>
...
#### Grouping fields<a name="grouping-fields"/>
...
## Wrapping Up for Famo.us<a name="wrapping-up-for-famo.us"/>
...
## Side Notes<a name="side-notes"/>



### 3rd Party Login Services Configuration<a name="3rd-party-login-services-configuration"/>
